...
pathname = os.path.join(dirname, 'aiterms.txt')  # original data
spathname = os.path.join(dirname, 'aiterms.txt')  # sorted data
...
layout = [[sg.Text('Search and Sort Demo', font=('Calibri', 20, 'bold'))],
          [sg.Listbox(values=[''], size=(14, 11), font=('Calibri', 12), background_color='White', key='_display_'),
           sg.Column(column1)],
          [sg.Text('_' * 38, font=('Calibri', 16))],
          [sg.InputText(size=(11, 1), key='_linear_'), sg.Text('   '), sg.InputText(size=(11, 1), key='_binary_')],
          [sg.ReadButton('Linear Search', size=(12, 1)), sg.Text('     '),
